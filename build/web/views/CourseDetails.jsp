                    ...
                    <div class="main-content">
                        ...
                        <c:if test="${course != null}">
                            ...
                            <c:if test="${not empty course.packages}">
                                <c:forEach var="pkg" items="${course.packages}">
                                    <div class="price-box">
                                        <div class="price-info">
                                            <h4>${pkg.name}</h4>
                                            <span class="original-price">$${pkg.originalPrice}</span>
                                            <span class="sale-price">$${pkg.salePrice}</span>
                            ...
                            <c:if test="${empty course.packages}">
                                <p>No packages available for this course.</p>
                            </c:if>
